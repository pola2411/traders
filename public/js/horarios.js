...
let par = separador[separador.length - 1];
function setData() {
    $.get({
        url: `/admin/showHorarios?par=${par}`,
        success: function (response) {
            $("#datosHorarios").append(response);
...
$(document).on("click", ".statusHorario", function (e) {
    e.preventDefault();
