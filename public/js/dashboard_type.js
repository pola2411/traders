...
$(document).ready(function () {
    let url = "/admin/showDashboardType";

    var tabla = $("#dashboard_type").DataTable({
        ajax: "/admin/showDashboardType",
        columns: [
            { data: "time" },
            { data: "type" },
            { data: "status" },
        ...
        language: {
            ...
            infoEmpty:
                "Mostrando datos del 0 al 0 de un total de 0 datos",
...
$(document).on("click", ".statusDashboard", function (e) {
    e.preventDefault();
...
$(document).on("click", "#statusGralDashboard", function (e) {
    e.preventDefault();
        ...
        preConfirm: (clave) => {
            $.ajax({
                ...
                success: function (result) {
                    if (result == "success") {
                        $.get(
                            "/admin/botonStatusGralDashboard",
                            {
                                campo: "statusGral",
                            },
                            function (response) {
