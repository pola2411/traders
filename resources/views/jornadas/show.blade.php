                ...
                <div class="card-body" style="padding-top: 20px;">
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-3 col-12">
                            ...
                            @endphp
                              <div class="form-floating mb-3 me-3">
                                  <select class="form-select" id="sessionSelect" aria-label="Floating label select example">
                        ...
                        @endphp
                          <div class="form-floating mb-3 me-3">
                              <select class="form-select" id="portfolioSelect" aria-label="Floating label select example">
                              <option value="0">Todas las sesiones</option>
